...
- **Take a relic it cannot give back.** A relic outside your character's relic pool is left alone, whoever added it. Without that rule a relic another mod grants through its own event could be swapped away every fight and never returned — a one-way door that strips you of exactly the content you installed. Custom relics from other mods do join the shuffle, on one condition: their pickup must do nothing special, because the reshuffle grants silently and any obtain-time setup would be skipped (vanilla's Fur Coat is the in-house proof that this breaks a relic outright).
